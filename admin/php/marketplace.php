...
$sql = "SELECT u.user_id,u.type_of_user,u.lname,u.fname,u.business_name,p.prod_name,p.prod_pic,p.category,p.prod_id FROM product_post AS p ,users AS u WHERE u.user_id= p.user_seller_id ORDER BY p.prod_id desc ";
