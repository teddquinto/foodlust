...
if(isset($admin)){ header('location:home.php'); } else { }
?>
<!Doctype html>
<html>
	<head>
	...
	<body>
		...
		function login(){  
				...
				$('#loginbtn').html('<img src=../users_ui/img/loader2.gif width=20%>');
				$('#erorr').hide();
				var user = $('#user').val();
				var pass = $('#pass').val();
				  ...
				  $.ajax({
 				  url: "php/login.php",
  				 data:'us='+user+'&pa='+pass,
  				 type: "POST",
  				  success: function( data ) {
                  if (data == '1') {
   				      $('#loginbtn').html('Login'); 
							document.location.href = 'php/php.php';     
   				  }else{
   				    $('#erorr').slideDown();
						$('#loginbtn').html('Login');
